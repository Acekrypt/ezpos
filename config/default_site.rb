...
module CDF
  ...
  :mail_temp_path => 'tmp/mail',
  :mail_filters_path => '/tmp',
  ...
  :imap_server => 'mail.allmed.net',
  :imap_use_ssl => false,
  :imap_port => 143,
  :imap_auth => 'PLAIN', # 'LOGIN', 'NOAUTH'
  :encryption_salt => 'Bu890@(lt',
  :encryption_password => '$Basd8b2/zcxv732cFD',
  :debug_imap => false,
  ...
  :send_from_domain => 'allmed.net', # Set this variable to your domain name in site.rb if you make login to imap only with username (without '@domain')
